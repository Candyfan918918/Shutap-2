...
const QA: { heading: string; body: string }[] = [
  ...
  { heading: "Is Shutap free?", body: "Yes. Guests get one situation a day, flip one of its three cards, and can share or save that card — 1080×1920 with a small shutap mark. Sharing and saving are free at every tier. A free alias — a fake name, no password — gets one situation a day and flips all three, kept in your set list and the Mirror's record, for free, forever. A membership ($7.99/month or $49.99/year) buys three situations a day, every set kept clean — no mark — and the Mirror reading." },
  ...
  { heading: "What does a membership actually buy?", body: "Room and a clean card: three situations a day instead of one, every set kept clean — no shutap mark; every card is the same phone-screen picture, 1080×1920, at every tier — and the Mirror reading the patterns across everything you keep. It does not buy advice, a diagnosis, or relief, and the jokes are the same jokes. There is no free trial: the first period is charged when you subscribe, and you can cancel anytime." },
