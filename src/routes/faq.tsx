...
const QA: { heading: string; body: string }[] = [
  ...
  { heading: "Is Shutap free?", body: "Yes. Guests get one situation a day and flip one of its three cards. A free alias — a fake name, no password — gets one situation a day and flips all three, kept in your set list and the Mirror's record, for free, forever. A membership ($7.99/month or $49.99/year) buys three situations a day, every set kept clean — no mark, print size — and the Mirror reading." },
