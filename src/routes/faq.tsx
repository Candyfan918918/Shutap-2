...
const QA: { heading: string; body: string }[] = [
  ...
  { heading: "Is Shutap free?", body: "Yes. Guests get one situation a day, flip one of its three cards, and can share or save that card — 1080×1920 with a small shutap mark. Sharing and saving are free at every tier. A free alias — a fake name, no password — gets one situation a day and flips all three, kept in your set list and the Mirror's record, for free, forever. A membership ($7.99/month or $49.99/year) buys three situations a day, every set kept clean — no mark, print size — and the Mirror reading." },
  ...
  { heading: "What gets kept when I sign in?", body: "Every card you flip — with an alias, that's all three of each situation. They go into your set list and into the Mirror's private record. Guests keep nothing until they pick an alias, at which point the card they had flipped comes with them and the other two become theirs to flip." },
  { heading: "What does a membership actually buy?", body: "Room and pixels: three situations a day instead of one, every set kept clean — no shutap mark at 2160×3840, every card saved at print size — and the Mirror reading the patterns across everything you keep. It does not buy advice, a diagnosis, or relief, and the jokes are the same jokes. There is no free trial: the first period is charged when you subscribe, and you can cancel anytime." },
